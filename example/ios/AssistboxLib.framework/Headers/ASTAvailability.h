...
#import "ASTAvailabilityDeprecated.h"
...
#define AST_VERSION [NSString stringWithFormat:@"%d.%d.%d", \
    (CORDOVA_VERSION_MIN_REQUIRED / 10000),                 \
    (CORDOVA_VERSION_MIN_REQUIRED % 10000) / 100,           \
    (CORDOVA_VERSION_MIN_REQUIRED % 10000) % 100]

// Enable this to log all exec() calls.
#define AST_ENABLE_EXEC_LOGGING 0
#if AST_ENABLE_EXEC_LOGGING
    #define AST_EXEC_LOG NSLog
#else
    #define AST_EXEC_LOG(...) do { \
} while (NO)
#endif
